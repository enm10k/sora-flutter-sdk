...
if [ ! -e $INSTALL_DIR/webrtc ]; then
  file=webrtc.ubuntu-20.04_armv8_jetson-${WEBRTC_VERSION}.tar.gz
  curl -Lo $INSTALL_DIR/$file https://github.com/shiguredo-webrtc-build/webrtc-build/releases/download/${WEBRTC_VERSION}/webrtc.ubuntu-20.04_armv8_jetson.tar.gz
