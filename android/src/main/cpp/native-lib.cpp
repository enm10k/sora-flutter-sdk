...
Java_jp_shiguredo_sora_1flutter_1sdk_SoraFlutterSdkPlugin_setApplicationContext(
    JNIEnv* env,
    jobject /* this */,
    jobject ctx) {
...
Java_jp_shiguredo_sora_1flutter_1sdk_SoraFlutterSdkPlugin_createSoraClient(
    JNIEnv* env,
    jobject /* this */,
    jobject binding,
    jint client_id,
  ...
  std::string event_channel =
      "SoraFlutterSdk/SoraClient/Event/" + std::to_string(client_id);
  ...
  jmethodID arg_id = env->GetMethodID(callcls.obj(), "argument",
                                      "(Ljava/lang/String;)Ljava/lang/Object;");
  std::string json;
  {
    webrtc::ScopedJavaLocalRef<jstring> str(
        env, (jstring)env->CallObjectMethod(call, arg_id,
  ...
  webrtc::ScopedJavaLocalRef<jclass> bindingcls(env,
                                                env->GetObjectClass(binding));
  jmethodID getbin =
      env->GetMethodID(bindingcls.obj(), "getBinaryMessenger",
                       "()Lio/flutter/plugin/common/BinaryMessenger;");
  jmethodID gettex = env->GetMethodID(bindingcls.obj(), "getTextureRegistry",
  ...
  webrtc::ScopedJavaLocalRef<jclass> intcls =
      webrtc::GetClass(env, "java/lang/Integer");
  jmethodID value_of_id =
      env->GetStaticMethodID(intcls.obj(), "valueOf", "(I)Ljava/lang/Integer;");
  webrtc::ScopedJavaLocalRef<jobject> client_id_obj(
      env, env->CallStaticObjectMethod(intcls.obj(), value_of_id, client_id));
  env->CallObjectMethod(mapobj.obj(), putid, env->NewStringUTF("client_id"),
                        client_id_obj.obj());
  env->CallObjectMethod(mapobj.obj(), putid, env->NewStringUTF("event_channel"),
                        env->NewStringUTF(event_channel.c_str()));
  webrtc::ScopedJavaLocalRef<jclass> resultcls(env,
                                               env->GetObjectClass(result));
  jmethodID successid =
      env->GetMethodID(resultcls.obj(), "success", "(Ljava/lang/Object;)V");
...
extern "C" JNIEXPORT void JNICALL
Java_jp_shiguredo_sora_1flutter_1sdk_SoraFlutterSdkPlugin_connectSoraClient(
    JNIEnv* env,
    jobject /* this */,
    jlong client,
    jobject call,
...
extern "C" JNIEXPORT void JNICALL
Java_jp_shiguredo_sora_1flutter_1sdk_SoraFlutterSdkPlugin_disposeSoraClient(
    JNIEnv* env,
    jobject /* this */,
    jlong client,
    jobject call,
...
extern "C" JNIEXPORT void JNICALL
Java_jp_shiguredo_sora_1flutter_1sdk_SoraFlutterSdkPlugin_destroySoraClient(
    JNIEnv* env,
    jobject /* this */,
    jlong client,
    jobject call,
...
extern "C" JNIEXPORT void JNICALL
Java_jp_shiguredo_sora_1flutter_1sdk_SoraFlutterSdkPlugin_sendDataChannel(
    JNIEnv* env,
    jobject /* this */,
    jlong client,
    jstring label,
  ...
  bool resp = reinterpret_cast<SoraClientWrapper*>(client)->p->SendDataChannel(
      c_label, c_data);

  // b = Boolean(resp);
  // result.success(b);
  webrtc::ScopedJavaLocalRef<jclass> boolcls =
      webrtc::GetClass(env, "java/lang/Boolean");
  jmethodID ctorid = env->GetMethodID(boolcls.obj(), "<init>", "(Z)V");
  webrtc::ScopedJavaLocalRef<jobject> boolobj(
      env, env->NewObject(boolcls.obj(), ctorid, resp));
  webrtc::ScopedJavaLocalRef<jclass> resultcls(env,
                                               env->GetObjectClass(result));
  jmethodID successid =
      env->GetMethodID(resultcls.obj(), "success", "(Ljava/lang/Object;)V");
...
extern "C" JNIEXPORT void JNICALL
Java_jp_shiguredo_sora_1flutter_1sdk_SoraFlutterSdkPlugin_enumVideoCapturers(
    JNIEnv* env,
    jobject /* this */,
    jobject call,
    jobject result) {
  // alist = ArrayList();
  webrtc::ScopedJavaLocalRef<jclass> alistcls =
      webrtc::GetClass(env, "java/util/ArrayList");
  jmethodID alist_ctorid = env->GetMethodID(alistcls.obj(), "<init>", "()V");
  webrtc::ScopedJavaLocalRef<jobject> alistobj(
      env, env->NewObject(alistcls.obj(), alist_ctorid));
  jmethodID alist_addid =
      env->GetMethodID(alistcls.obj(), "add", "(Ljava/lang/Object;)Z");

  webrtc::ScopedJavaLocalRef<jclass> mapcls =
      webrtc::GetClass(env, "java/util/HashMap");
  jmethodID map_ctorid = env->GetMethodID(mapcls.obj(), "<init>", "()V");
  jmethodID map_putid = env->GetMethodID(
      mapcls.obj(), "put",
      "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;");
  sora_flutter_sdk::DeviceList::EnumVideoCapturer(
      [alistobj, alist_addid, mapcls, map_ctorid, map_putid, env](
        ...
        // alist.add(m);
        webrtc::ScopedJavaLocalRef<jobject> mapobj(
            env, env->NewObject(mapcls.obj(), map_ctorid));
        env->CallObjectMethod(mapobj.obj(), map_putid,
                              env->NewStringUTF("device"),
                              env->NewStringUTF(device_name.c_str()));
        env->CallObjectMethod(mapobj.obj(), map_putid,
                              env->NewStringUTF("unique"),
                              env->NewStringUTF(unique_name.c_str()));
...
extern "C" JNIEXPORT void JNICALL
Java_jp_shiguredo_sora_1flutter_1sdk_SoraFlutterSdkPlugin_switchVideoDevice(
    JNIEnv* env,
    jobject /* this */,
    jobject client,
    jobject call,
...
extern "C" JNIEXPORT void JNICALL
Java_jp_shiguredo_sora_1flutter_1sdk_SoraFlutterSdkPlugin_setVideoEnabled(
    JNIEnv* env,
    jobject /* this */,
    jlong client,
    jboolean flag,
...
extern "C" JNIEXPORT void JNICALL
Java_jp_shiguredo_sora_1flutter_1sdk_SoraFlutterSdkPlugin_setAudioEnabled(
    JNIEnv* env,
    jobject /* this */,
    jlong client,
    jboolean flag,
...
extern "C" JNIEXPORT void JNICALL
Java_jp_shiguredo_sora_1flutter_1sdk_SoraFlutterSdkPlugin_setLyraModelPath(
    JNIEnv* env,
    jobject /* this */,
    jstring path,
    jobject call,
