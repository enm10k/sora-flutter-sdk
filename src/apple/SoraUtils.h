...
+ (std::string)stdString:(NSDictionary<NSString*, id>*)dictionary
                  forKey:(NSString*)key;
+ (std::vector<std::string>)stdStrings:(NSDictionary<NSString*, id>*)dictionary
                                forKey:(NSString*)key;
+ (int64_t)intValue:(NSDictionary<NSString*, id>*)dictionary
             forKey:(NSString*)key;
